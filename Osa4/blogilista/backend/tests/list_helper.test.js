...
describe('favorite blogger', () => {
  ...
  test('when list has only one blog favorite blogger is that', () => {
    const result = listHelper.favoriteBlogger(listWithOneBlog)
    expect(result).toEqual({
      author: 'Edsger W. Dijkstra',
      likes: 5,
    })
  })
  test('when list has many blogs favorite blogger is', () => {
  ...
  test('when list has no blogs the favorite blogger is empty', () => {
    const result = listHelper.favoriteBlogger(listWithNoBlogs)
    expect(result).toEqual({
      author: '',
      likes: 0
    })
